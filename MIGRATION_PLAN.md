...
- Version bump to 3.1.8 is present in `package.json` and `module.json`
...
- Announcement: Vortex System Optimizer v3.1.8 — Atlas Engine Edition
- Key points:
...
- `package.json` — version bump to 3.1.8
