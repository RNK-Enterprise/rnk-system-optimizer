...
- Version bump to 3.1.9 is present in `package.json` and `module.json`
...
- Announcement: Vortex System Optimizer v3.1.9 — Atlas Engine Edition
- Key points:
...
- `package.json` — version bump to 3.1.9
