...
- Version bump to 3.1.7 is present in `package.json` and `module.json`
...
- Announcement: Vortex System Optimizer v3.1.7 — Atlas Engine Edition
- Key points:
